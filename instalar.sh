...
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3h4bm54eG5uL2V4dHJlbS9tYXN0ZXIvcmVxdWVzdA=="
SUB_DOM='base64 -d'
...
fun_ip
wget -O /usr/bin/trans https://raw.githubusercontent.com/xxnnxxnn/extrem/master/Install/trans &> /dev/null
clear
msg -bar2
